...
public class CTPhieuNhap extends JDialog implements ActionListener{
	...
	public CTPhieuNhap(String maPhieu)
	{	
		...
		lbNCC.setBounds(396, 124, 93, 20);
		getContentPane().add(lbNCC);
		...
		txtNCC.setBounds(499, 120, 154, 30);
	...
	public void loadDataTable(List<Product> list) {
		...
		for (Product p : list) {
			...
			String total = String.format("%.1f",p.getGiaNhap()*p.getSoLuong()) ;
