...
public class AdminSideBar extends SideBar implements ActionListener{
	...
	public AdminSideBar (JPanel mainConPanel, JFrame frame,String username) {
        ...
        add(lbUserName);
		ImageIcon iconProduct = new  ImageIcon("src/Assets/Icon/icons8-product-40.png");
		...
		ImageIcon iconNH= new  ImageIcon("src/Assets/Icon/icons8-export-40.png");
		...
		ImageIcon iconXH= new  ImageIcon("src/Assets/Icon/icons8-import-40.png");
		...
		ImageIcon iconPN= new  ImageIcon("src/Assets/Icon/icons8-PhieuNhap-40.png");
		...
		ImageIcon iconPX= new  ImageIcon("src/Assets/Icon/icons8-receipt-40.png");
		...
		ImageIcon iconNCC= new  ImageIcon("src/Assets/Icon/icons8-supplier-40.png");
		...
		ImageIcon iconAccount= new  ImageIcon("src/Assets/Icon/icons8-account-40.png");
	    btnTK = new JButton("TÀI KHOẢN", iconAccount);
		btnTK.setBounds(0, 453, 300, 55);
		btnTK.setFont(customFont);
		btnTK.setForeground(white);
		add(btnTK);
		setButtonTransparent(btnTK);
		
		
		ImageIcon iconThongKe= new  ImageIcon("src/Assets/Icon/icons8-analytics-40.png");
	    btnThongKe = new JButton("THỐNG KÊ", iconThongKe);
		btnThongKe.setBounds(0, 506, 300, 55);
		btnThongKe.setFont(customFont);
		btnThongKe.setForeground(white);
		add(btnThongKe);
		setButtonTransparent(btnThongKe);
		
		ImageIcon iconInfo= new  ImageIcon("src/Assets/Icon/icons8-edit-40.png");
		...
		ImageIcon iconLogout= new  ImageIcon("src/Assets/Icon/icons8-logout-40.png");
	...
	public void actionPerformed(ActionEvent e) {
		...
		case "PHIẾU NHẬP":
			...
			break;
		case "TÀI KHOẢN":
			switchContent(new TaiKhoanView(frame), btnTK);
			break;
		case "THỐNG KÊ":
