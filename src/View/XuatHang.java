...
public class XuatHang extends JPanel implements ActionListener {
	...
	public XuatHang(String usernameCurrent) {
	...
	public void initRightPanel() {
		...
		txtMaPhieu.setText("PX" + (PhieuXuatDAO.getInstance().quantity() + 1) + "");
		...
		lb4.setBounds(38, 90, 98, 26);
		panel_3.add(lb4);

		txtNguoiTao = new JTextField();
		txtNguoiTao.setBounds(192, 90, 332, 38);
		...
		btnXuatHang.setBounds(437, 706, 113, 44);
		btnXuatHang.setBackground(Color.cyan);
		panel_3.add(btnXuatHang);
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (button.equals(btnAdd)) {
			...
			deleteProduct();
		} else if (button.equals(btnXuatHang)) {
			xuatHang();
	...
	private void xuatHang() {
		if (table2.getModel().getRowCount() != 0) {
	        ...
	        if (result == JOptionPane.YES_OPTION) {
	           ...
	           pdf.xuatPhieuXuat(txtMaPhieu.getText());
